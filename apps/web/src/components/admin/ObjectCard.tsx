...
export function ObjectCard({
  ...
  return (
    <button
      ...
      className={`w-full rounded-[20px] border px-5 py-5 text-left transition-colors duration-200 ${
        selected ? "border-accent bg-surface" : "border-line bg-surface hover:bg-surface-muted/40"
      }`}
    >
