...
export async function POST(request: Request) {
  ...
  const result = await rpcWith<{ userId?: string; membershipId?: string | null; sessionVersion?: number; redirectTo?: string; message?: string }>(null, "login", body, clientFrom(request.headers));
